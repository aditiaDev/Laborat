                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Kode Laborat</label>
                      <input type="text" class="form-control" name="id_laborat">
                    </div>
                  </div>
                  <div class="col-sm-9">
                    <div class="form-group">
  ...
  <script>
    ...
    $(function(){
      ...
      $("#add_data").click(function(){
        ...
        $("[name='id_laborat']").attr('readonly', false)
      ...
      $("#BTN_SAVE").click(function(){
        ...
        if(save_method == 'save') {
            urlPost = "<?php echo site_url('laborat/saveData') ?>";
        }else{
            urlPost = "<?php echo site_url('laborat/updateData') ?>";
            formData+="&id_laborat="+id_data
        }
    ...
    function REFRESH_DATA(){
      ...
      var tb_data =  $("#tb_data").DataTable({
          ...
          "responsive": true,
          "ajax": {
              "url": "<?php echo site_url('laborat/getAllData') ?>",
              "type": "POST",
          },
          "columns": [
              { "data": "id_laborat" },
              ...
              { "data": null, 
                "render" : function(data){
                  return "<button class='btn btn-sm btn-warning' title='Edit Data' onclick='editData("+JSON.stringify(data)+");'><i class='bi bi-pencil-square'></i> </button> "+
                    "<button class='btn btn-sm btn-danger' title='Hapus Data' onclick='deleteData(\""+data.id_laborat+"\");'><i class='bi bi-trash'></i> </button>"
                },
    ...
    function editData(data, index){
      console.log(data)
      save_method = "edit"
      id_data = data.id_laborat;
      $("#modal_add .modal-title").text('Edit Data')
      $("[name='id_laborat']").val(data.id_laborat)
      $("[name='deskripsi']").val(data.deskripsi)
      $("[name='id_laborat']").attr('readonly', true)
      $("#modal_add").modal('show')
    }
    ...
    function deleteData(id){
      ...
      urlPost = "<?php echo site_url('laborat/deleteData') ?>";
      formData = "id_laborat="+id
      ACTION(urlPost, formData)
    }
  </script>